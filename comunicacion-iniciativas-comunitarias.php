...
$PageTitle = "Comunicación e iniciativas comunitarias | Ciencia Puerto Rico"; 
$page = "educación"; 
...
$breadcrumb_path = [
    "Comunicación e iniciativas comunitarias" => SERVER_URI . 'comunicacion-iniciativas-comunitarias.php',
];
...
<main>
    ...
    <section class="container-fluid p-0 explora-hero page-hero-bg bg-img_comunicacion-iniciativas d-flex align-items-center" style="min-height: 250px;">
        
        <div class="container">
            <!-- TÍTULO H1 -->
            <h1 class="fw-bold mb-3 text-body">Comunicación e iniciativas comunitarias</h1>
                ...
                <div class="col-12 col-md-6 d-flex flex-column">
                    <div class="card border-0 bg-white rounded-20 p-5 flex-grow-1">
                        <div class="card-body p-0">
                            <h2 class="fs-2 fw-semibold">La ciencia al alcance de todos</h2>
                            <p class="fs-5 card-text fw-normal">La ciencia está en todo lo que hacemos. Descubre cómo impacta nuestra vida diaria, nuestro ambiente y el futuro de Puerto Rico a través de historias, proyectos y recursos creados para ti.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 d-flex flex-column">
                    <img class="rounded-20 w-100 flex-grow-1 object-fit-cover" src="<?= SERVER_URI ?>images/comunicacion-iniciativas-comunitarias-top.png" alt="Profesional con bata" >
                </div>
            </div>
        </div>
    </section>
        ...
        <div id="sliderContainer" class="row flex-nowrap overflow-x-auto no-scrollbar g-4 pb-5 scroll-smooth">
          ...
          <div class="col-11 col-md-5 col-lg-peek-3 flex-shrink-0">
            <div class="card h-100 min-h-card border-0 shadow-sm rounded-2 bg-light">
              <img src="<?= SERVER_URI ?>images/iniciativas-semillas.jpg" class="card-img-top border-bottom border-8 border-tertiary" alt="Convocatorias">
              <div class="card-body d-flex flex-column justify-content-between p-4">
                <div>
                  <h3>Comunicación científica</h3>
          ...
          <div class="col-11 col-md-5 col-lg-peek-3 flex-shrink-0">
            <div class="card h-100 min-h-card border-0 shadow-sm rounded-2 bg-light">
              <img src="<?= SERVER_URI ?>images/iniciativas-centificos-servicio.jpg" class="card-img-top border-bottom border-8 border-tertiary" alt="Programas">
              <div class="card-body d-flex flex-column justify-content-between p-4">
                <div>
                  <h3>Aquí Nos Cuidamos</h3>
          ...
          <div class="col-11 col-md-5 col-lg-peek-3 flex-shrink-0">
            <div class="card h-100 min-h-card border-0 shadow-sm rounded-2 bg-light">
              <img src="<?= SERVER_URI ?>images/iniciativas--yale-academy.jpg" class="card-img-top border-bottom border-8 border-tertiary" alt="Eventos">
              <div class="card-body d-flex flex-column justify-content-between p-4">
                <div>
                  <h3>CienciaCoLab</h3>
          ...
          <div class="col-11 col-md-5 col-lg-peek-3 flex-shrink-0">
            <div class="card h-100 min-h-card border-0 shadow-sm rounded-2 bg-light">
              <img src="<?= SERVER_URI ?>images/1-convocatorias.png" class="card-img-top border-bottom border-8 border-tertiary" alt="Convocatorias">
              <div class="card-body d-flex flex-column justify-content-between p-4">
                <div>
                ...
                <div class="row gx-5 gy-4 gy-sm-0">
                    ...
                    <div class="col-12 col-md-3 d-flex flex-column justify-content-center">
                      <div class="border-bottom">
                        <p class="fs-2 fw-semibold">1,500+</p>
                        <p class="fs-5 fw-normal">Oyentes y lectores alcanzados</p>
                      </div>
                      <div class="border-bottom">
                        <p class="fs-2 fw-semibold">250+</p>
                        <p class="fs-5 fw-normal">Radiocápsulas publicadas</p>
                      </div>
                      <div>
                        <p class="fs-2 fw-semibold">18</p>
                        <p class="fs-5 fw-normal">Años de divulgación científica</p>
                      </div>
                    </div>

                    <!-- Columna 2 -->
                    <div class="col-12 col-md-4">
                        <img src="<?= SERVER_URI ?>images/comunicacion-iniciativas-comunitarias-impacto.png" alt="Profesional de ciencia con bata y con una flask en la mano" class="w-100 h-100 object-fit-cover rounded-20">
                    </div>

                    <!-- Columna 3 -->
                    <div class="col-12 col-md-5 d-flex flex-column justify-content-center">
                        <h2 class="fs-2 fw-semibold mb-md-3">Un impacto real que acerca la ciencia a nuestra gente</h2>
            ...
            <div class="row g-4">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="h-100 d-flex flex-column align-items-start">
                        <div class="d-flex flex-column justify-content-between align-items-start">
                            <div>
                                <h4>Libro Ciencia y Solidaridad</h4>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="h-100 d-flex flex-column align-items-start">
                        <div class="d-flex flex-column justify-content-between align-items-start">
                            <div>
                                <h4>Campaña Salud Mental es plenitud</h4>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="h-100 d-flex flex-column align-items-start">
                        <div class="d-flex flex-column justify-content-between align-items-start">
                            <div>
                                <h4>Cuaderno de reflexividad</h4>
            ...
            <div class="row gx-md-5 gy-4 align-items-stretch">
                <div class="col-12 col-md-6 d-flex flex-column gap-4">
                    <div class="card bg-white border-0 rounded-20 p-5 h-100 d-flex flex-column">
                        <div class="p-0">
                            <h2 class="fs-2 fw-semibold">Únete a nuestra misión de divulgación científica</h2>
                            <p class="fs-5 card-text fw-normal">Ser parte de nuestra red significa unirte a un movimiento que promueve el conocimiento, la educación y la divulgación científica para toda nuestra comunidad. Colaboramos con organizaciones, escuelas, medios, científicos, comunicadores y ciudadanos que desean aportar a un Puerto Rico más informado, crítico y preparado para enfrentar los retos del presente y del futuro.</p>
                        </div>
                        <div class="row mt-5">
                            <div class="col-12">
                ...
                <div class="col-12 col-md-6 d-flex">
                    <img class="rounded-20 w-100 h-100 object-fit-cover" src="<?= SERVER_URI ?>images/comunicacion-iniciativas-comunitarias-unete.png" alt="Doctor de ls comunidad de CienciaPR" >
                </div>
            </div>
        </div>
    </section>
