...
$PageTitle = "Catálogo de recursos educativos | Ciencia Puerto Rico";
$page = "explora"; 
...
$breadcrumb_path = [
    "Explora" => SERVER_URI . 'recursos-educativos.php',
];
...
<main>
    ...
    <section class="container-fluid p-0 descubre-hero d-flex align-items-center" style="min-height: 250px;">
        ...
        <div class="container">
            <!-- TÍTULO H1 -->
            <h1 class="fw-bold mb-3 text-body">Catálogo de recursos educativos</h1>
